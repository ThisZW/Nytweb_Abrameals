...
class Mage_Sales_Block_Recurring_Profile_View extends Mage_Core_Block_Template
{
    ...
    public function prepareViewData()
    {
        $this->addData(array(
			...
			//6-22-2016
			'redirect_to_update_url' => $this->getUrl('*/*/updateState', array('profile' => $this->_profile->getId(), 'action' => 'redirect_to_update')),
			//6-8-2016 by Chris
			'schedule_to_freeze_url' => $this->getUrl('*/*/updateState', array('profile' => $this->_profile->getId(), 'action' => 'schedule_to_freeze')),
			'has_freeze_schedule' =>$this->_profile->hasFreezeSchedule($this->_profile->getId()),
			'freeze_schedule' => $this->_profile->freezeSchedule($this->_profile->getId()),
			//end
