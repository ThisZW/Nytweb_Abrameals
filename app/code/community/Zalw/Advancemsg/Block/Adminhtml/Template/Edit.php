 ...
 * @author      Zalw
 * @use	   	To show the message template edit
 */
class Zalw_Advancemsg_Block_Adminhtml_Template_Edit extends Mage_Adminhtml_Block_Widget
{
    /**
     * Edit Block model
     *
    ...
    {
        if ($this->getEditMode()) {
            return Mage::helper('advancemsg')->__('Edit Messages Template');
        }

        return  Mage::helper('advancemsg')->__('New Messages Template');
    }
    ...
    public function getForm()
    {
        return $this->getLayout()            
            ->createBlock('advancemsg/adminhtml_template_edit_form')
            ->toHtml();
    }
