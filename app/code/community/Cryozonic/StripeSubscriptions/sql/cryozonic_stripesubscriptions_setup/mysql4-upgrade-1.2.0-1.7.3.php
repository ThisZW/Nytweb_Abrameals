...
if (!$customer->getId())
{
    ...
    try
    {
        $installer->run("INSERT INTO customer_entity (entity_id, entity_type_id, email, group_id, created_at, is_active) VALUES (1, 1, 'dont-delete@cryozonic-stripe-subscriptions.com', 1, 0, 0)");
    }
    catch (Exception $e) { }
}
