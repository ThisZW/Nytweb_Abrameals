 ...
 * @author      Zalw
 * @use	   	To show checkbox on customer's send message grid
 */
class Zalw_Advancemsg_Block_Messagegrid_Filter_Checkbox extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
